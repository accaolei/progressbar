...
[![godocs](https://godoc.org/github.com/schollz/progressbar?status.svg)](https://godoc.org/github.com/accaolei/progressbar/v3) 
...
```
go get -u github.com/accaolei/progressbar/v3
```
...
There is a lot of customization that you can do - change the writer, the color, the width, description, theme, etc. See [all the options](https://pkg.go.dev/github.com/accaolei/progressbar/v3?tab=doc#Option).
